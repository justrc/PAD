...
def askQuestion():
    ...
    if(len(used) >9): # to only ask the user 10 of the 30 questions from the text file
        ...
        index=random.randint(0,30) # for the program to randomly choose one of the 30 questions at random so there isnt a fixed order or the same questions every attempt
